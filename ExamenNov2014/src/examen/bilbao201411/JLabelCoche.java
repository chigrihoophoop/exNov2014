 ...
 */
public class JLabelCoche extends JLabel implements Serializable {
	...
	private static boolean DIBUJAR_ESFERA_COCHE = false; // Dibujado (para depuración) del bounding circle de choque del coche
	private static boolean DIBUJAR_RECTANGULO = false; // Dibujado (para depuración) del rectángulo del label del coche
...
//		super.paintComponent(g);   // En este caso no nos sirve el pintado normal de un JLabel
        ...
        if (DIBUJAR_RECTANGULO) g2.drawRect(0, 0, TAMANYO_COCHE-1, TAMANYO_COCHE-1);
